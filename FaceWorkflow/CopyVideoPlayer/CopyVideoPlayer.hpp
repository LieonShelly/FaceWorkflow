...
#ifndef CopyVideoPlayer_hpp
#define CopyVideoPlayer_hpp
...
private:
    ...
    using DidDecodeVideoFrame = void (*)(void * userData, CopyVideoPlayer*player, uint8_t *data, VideoSwsSpec outSpec);
    using StateChanged = void(*)(void *userData, CopyVideoPlayer *player);
    using TimeChanged = void(*)(void *userData, CopyVideoPlayer *player);
    using PlayerFailed = void(*)(void *userData, CopyVideoPlayer *player);
