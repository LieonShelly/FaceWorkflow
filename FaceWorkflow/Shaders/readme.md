...
# 
./shadercRelease  -f fs_blueColor.sc -o Shaders.bundle/metal/fs_blueColor.bin --depends -i src --varyingdef image.def --platform osx -p metal 120 --type fragment -O3

-   ./shadercRelease  -f vc_image.sc -o Shaders.bundle/metal/vc_image.bin --depends -i src --varyingdef image.def --platform osx -p metal 120 --type vertex -O3
